...
public:
  ...
  /// subsequent lookups.
  /// The mutex is the one to be locked when working with the file.
  bool openIndex( File::Index & file, QMutex & mutex );
...
protected:
  ...
  std::unique_ptr< File::Index > headwordsIdxFile;
  QMutex headwordsMutex;
