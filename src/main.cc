...
int main( int argc, char ** argv )
{
  ...
  if (cfg.preferences.enableInterfaceFont && !cfg.preferences.interfaceFont.isEmpty() && font.family() != cfg.
  ...
  //system font size
  if (cfg.preferences.enableInterfaceFont && cfg.preferences.interfaceFontSize >= 8 && cfg.preferences.interfaceFontSize
      <= 32) {
